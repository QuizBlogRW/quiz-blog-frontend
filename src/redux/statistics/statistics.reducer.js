...
const INITIAL_STATE = {
  ...
  isDailyUserRegistrationLoading: true,
...
const statisticsReducer = (state = INITIAL_STATE, action) => {
  ...
  switch (action.type) {
    ...
    case GET_DAILY_USER_REGISTRATION:
      return {
        ...state,
        isDailyUserRegistrationLoading: false,
        dailyUserRegistration: action.payload
      }
    ...
    case DAILY_USER_REGISTRATION_LOADING:
      return {
        ...state,
        isDailyUserRegistrationLoading: true
      }
    ...
    case GET_DAILY_USER_REGISTRATION_FAIL:
      return {
        ...state,
        msg: "Failed!"
      }
