...
export const GET_ACTIVE_ADVERTS = 'GET_ACTIVE_ADVERTS'
export const GET_ACTIVE_ADVERTS_FAIL = 'GET_ACTIVE_ADVERTS_FAIL'

export const CHANGE_ADVERT_STATUS = 'CHANGE_ADVERT_STATUS'
