...
export const getImageUploads = () => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'GET_IMAGE_UPLOADS_FAIL'))
...
export const getOneImageUpload = (imageUploadID) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'GET_ONE_IMAGE_UPLOAD_FAIL'))
...
export const getImageUploadsByOwner = (ownerID) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'GET_IMAGE_UPLOADS_BY_OWNER_FAIL'))
...
export const createImageUpload = (newImageUpload, onUploadProgress) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'CREATE_IMAGE_UPLOAD_FAIL'))
...
export const updateBlogPost = updatedImgUpload => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'UPDATE_IMAGE_UPLOAD_FAIL'))
...
export const deleteBlogPost = id => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'DELETE_IMAGE_UPLOAD_FAIL'))
