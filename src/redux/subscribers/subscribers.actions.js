...
export const subscribeToNewsLetter = (subscribedUser) => async (dispatch) => {
  ...
  try {
    ...
    dispatch(returnErrors(err && err.response && err.response.data, err && err.response && err.response.status, 'SUBSCRIBE_FAIL'))
...
export const deleteSubscriber = uemail => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err && err.response && err.response.data, err && err.response && err.response.status, 'DELETE_SUBSCRIBER_FAIL'))
