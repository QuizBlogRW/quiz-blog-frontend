...
export const getRankingScores = (chQuizID) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'GET_RANKING_CHALLENGE_SCORES_FAIL'));
...
export const getTakerScores = (takerId) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'GET_TAKER_CHALLENGE_SCORES_FAIL'));
...
export const getCreatorScores = (uId) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response && err.response.data, err.response.status, 'GET_CREATOR_CHALLENGE_SCORES_FAIL'));
...
export const getOneScore = (scoreId) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'GET_ONE_CHALLENGE_SCORE_FAIL'));
...
export const createChScore = (newChScore) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'CREATE_CHALLENGE_SCORE_FAIL'));
...
export const updateChScore = updatedChScore => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'UPDATE_CHALLENGE_SCORE_FAIL'));
...
export const deleteChScore = id => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'DELETE_CHALLENGE_SCORE_FAIL'));
