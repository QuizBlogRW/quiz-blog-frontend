...
export const getOneQuestion = (chQnId) => async (dispatch) => {
    ...
    try {
        ...
        dispatch(returnErrors(err.response.data, err.response.status, 'GET_ONE_CHALLENGE_QUESTION_FAIL'))
...
export const addChQuestion = (chQuestion, onUploadProgress) => async (dispatch, getState) => {
    ...
    try {
        ...
        dispatch(returnErrors(err.response.data, err.response.status, 'ADD_CHALLENGE_QUESTION_FAIL'))
...
export const updateChQuestion = (qtId, updatedChQuestion, onUploadProgress) => async (dispatch, getState) => {
    ...
    try {
        ...
        dispatch(returnErrors(err.response.data, err.response.status, 'UPDATE_CHALLENGE_QUESTION_FAIL'))
...
export const deleteChQuestion = id => async (dispatch, getState) => {
    ...
    try {
        ...
        dispatch(returnErrors(err.response.data, err.response.status, 'DELETE_CHALLENGE_QUESTION_FAIL'))
