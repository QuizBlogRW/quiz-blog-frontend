...
export const getChallengerChallenges = (challengerId) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'GET_CHALLENGER_CHALLENGES_FAIL'));
...
export const getOneChallenge = (challengeId) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'GET_ONE_CHALLENGE_FAIL'));
...
export const createChallenge = (newChallenge) => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'CREATE_CHALLENGE_FAIL'));
...
export const updateChallenge = updatedChallenge => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'UPDATE_CHALLENGE_FAIL'));
...
export const deleteChallenge = id => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch(returnErrors(err.response.data, err.response.status, 'DELETE_CHALLENGE_FAIL'));
