...
const questionsCommentsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(deleteComment.fulfilled, (state, action) => {
      state.allQuestionsComments = state.allQuestionsComments.filter(
        (comment) => comment._id !== action.payload._id
      );
      state.isLoading.allQuestionsComments = false;
    });
...
export const {
  ...
  clearCommentsByQuiz,
  clearOneComment,
  clearQuestionsComments,
  clearPaginatedQuestionsComments,
  clearPendingQnsComments,
} = questionsCommentsSlice.actions;
