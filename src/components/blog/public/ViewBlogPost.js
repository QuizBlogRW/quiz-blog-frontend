...
const ViewBlogPost = ({ bposts, getOneBlogPost }) => {
    ...
    const bPCatID = bpToUse.postCategory && bpToUse.postCategory._id

    return (
        <Container className="blog-post-view p-0 p-lg-5 mw-100" style={{ backgroundColor: bpToUse.bgColor || '#f3f3f2' }}>
