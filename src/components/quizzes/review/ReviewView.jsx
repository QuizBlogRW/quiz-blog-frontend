        ...
        <Row>
            <Col>
                ...
                <div className="prevNext d-flex justify-content-between align-items-center mt-5">
                    <Button style={{ color: 'var(--brand)', backgroundColor: 'var(--accent)' }} className="ms-0 ms-md-5 p-1 px-md-2" onClick={handlePrevAnswer}>Previous</Button>
                    <Badge href="#" color={trueAnsNbr === trueChoicesNbr ? 'success' : 'danger'}>
                        {`Your answer was ${trueAnsNbr === trueChoicesNbr ? 'correct' : 'incorrect'}`}
                    </Badge>
                    <Button style={{ color: 'var(--brand)', backgroundColor: 'var(--accent)' }} className="me-0 me-md-5 p-1 px-md-2" onClick={handleNextAnswer}>
