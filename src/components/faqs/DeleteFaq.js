...
import { deleteFaq } from '../../redux/faqs/faqs.actions'
import { clearErrors } from '../../redux/error/error.actions'
import { clearSuccess } from '../../redux/success/success.actions'

const DeleteFaq = ({ deleteFaq, faqID, errors, successful }) => {
...
export default connect(mapStateToProps, { deleteFaq, clearErrors, clearSuccess })(DeleteFaq)