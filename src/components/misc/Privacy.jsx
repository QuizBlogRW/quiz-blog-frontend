            ...
            <Card className="border-0 shadow-sm">
                ...
                <CardBody className="p-3 p-md-4">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Quiz-Blog, accessible from <a href="https://www.quizblog.rw/" target="_blank" rel="noopener noreferrer">https://www.quizblog.rw/</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>By visiting this page on our website: <a href="https://www.quizblog.rw/contact" target="_blank" rel="noopener noreferrer" >https://www.quizblog.rw/contact</a></p>
                        </li>
                    </ul>
